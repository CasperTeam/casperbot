...
**Views :** `{views}`
        ...
        nice_text = f"**satyaUserBot Commands** \n**satya Version :** __{friday_version}__ \n**PyroGram Version :** __{__version__}__ \n**Total Plugins Loaded :** __{total_}__ \n**Master :** satya"
...
async def update_it(client, cb):
    ...
    try:
        ...
        return await cb.edit_message_text(
            "`Invalid Git Command. Please Report This Bug To @casperbotcupport`",
            reply_markup=InlineKeyboardMarkup(bttn)
        )
...
async def get_back_vro(client, cb):
    ...
    nice_text = f"**satyaUserBot Commands & Help Menu!** \n\n**Satya Version :** __{friday_version}__ \n**PyroGram Version :** __{__version__}__ \n**Total Plugins Loaded :** __{len(CMD_LIST)}__\n**master :** satya"
...
async def give_plugin_cmds(client, cb):
    ...
    help_string += "\n\n**(C) @casperbotsupport** ".format(plugin_name)
    await cb.edit_message_text(
        help_string,
        reply_markup=InlineKeyboardMarkup(
            [
