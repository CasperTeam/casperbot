...
class Config(object):
    ...
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC", "https://telegra.ph/file/d26d6660a0935f83fb805.jpg"
    )
    ...
    SUDO_USERS = set(int(x) for x in os.environ.get("SUDO_USERS", "1741347822").split())
    AFS = list(SUDO_USERS)
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/casperteam/casperbot"
    )
    ALIVE_IMG = os.environ.get(
        "ALIVE_IMG", "https://telegra.ph/file/d26d6660a0935f83fb805.jpg"
    )
    U_BRANCH = "master"
