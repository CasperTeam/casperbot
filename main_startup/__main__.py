...
async def run_bot():
    ...
    full_info = f"""satya Based On Pyrogram V{__version__}
Python Version : {platform.python_version()}
satya Version : {friday_version}
You Can Visit @casperbot_mix For Updates And @casperbotSupport For Any Query / Help!
"""
